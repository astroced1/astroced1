...
alias gc='git clone $argv'

# Snapper
alias snaplist='sudo snapper list'  # Lists snapshots 
abbr -a snapcr 'sudo snapper create --description '    # Create Snapshot --- add description after with "DESCRIPTION_EXAMPLE"
